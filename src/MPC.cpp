...
public:
    ...
    void operator()(ADvector &fg, const ADvector &vars) {
      ...
      for (size_t t = 1; t < N; t++) {
        ...
        // The state at time t.
        AD<double> x0 = vars[x_start + t - 1]; // values at time t
        ...
        AD<double> x1 = vars[x_start + t];  // values at time t+1
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Set all non-actuator lower and upper limits
  ...
  double max_radians = 25.0 * M_PI / 180.0; // deg -> radians
  ...
  if (debug_flag) cout << "Cost " << cost << endl;
